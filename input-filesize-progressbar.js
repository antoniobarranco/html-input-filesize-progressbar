...
function updateProgressBar(currentSize, maxSize = 5242880) {
    ...
    if (currentPercent <= 100) {
        ...
        document.getElementById("fileSizeIndicatorLabel").textContent = currentPercent + "% - " + formatBytes(currentSize);
        document.getElementById("fileSizeIndicator").setAttribute("title", currentPercent + "% - " + formatBytes(currentSize));
        ...
        document.getElementById("fileSizeIndicatorLabel").textContent = formatBytes(currentSize) + " Error: Total file size exceeds limit";
        document.getElementById("fileSizeIndicator").setAttribute("title", formatBytes(currentSize) + " Error: Total file size exceeds limit");
